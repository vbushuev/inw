...
static sStep mainScenario[]={
	...
	{H_01,{0,H_15},H_00,0},//10

	{H_00,{3,H_00},H_00,0},  //11    Произвести фиксацию замеров для левого

	{H_13,{0,H_10},H_00,0},//12
	{H_14|H_20,{2,H_00/*rtv.RC*/},H_00,0},//13
	{H_13,{0,H_11},H_00,0},//14
	{H_12,{0,H_09},H_00,0},//15
	{H_14|H_20,{0,H_12},H_00,0},//16
	{H_16,{0,H_13},H_00,0},//17
	{H_18|H_01,{0,H_01/*rtv.ttaker*/},H_18,0},//18
	{H_15|H_18,{2,H_00/*rtv.Rh*/},H_18,0},//19
	{H_18|H_19,{1,H_00/*rtv.tV19*/},H_18,0},//20
	{H_17|H_18,{0,H_14},H_00,0},//21
	{H_02,{0,H_15},H_00,0},//22
	{H_00,{4,H_00},H_00,0}  //23    Произвести фиксацию замеров для левого
};
static sStep lencScenario[]={
   {H_05,{0,H_06},H_00,0},//00
   {H_06,{2,H_00/*rtv.Lh*/},H_00,0},//00
   {H_00,{5,H_00},H_00,0} //02 finish
};
static sStep rencScenario[]={
...
static sStep setupRightScenario[] = {
...
static sStep setupLeftScenario[] = {
   {H_03,{0,H_03},H_00,0},//00
		 ...
		 **************************************************************************/
		 ...
		 if(finished){
			 ...
			 case 0x5: {// Main scenario{}
				...
				mainScenario[7].wait.value = gRegisters[0x03];
				mainScenario[8].wait.value = gRegisters[0x00];// v10

				mainScenario[13].wait.value = gRegisters[0x05] - gRegisters[0x04];
				//mainScenario[19].wait.value = gRegisters[0x0b]; // ttaker
				mainScenario[19].wait.value = gRegisters[0x05];
				mainScenario[20].wait.value = gRegisters[0x01]; //V19

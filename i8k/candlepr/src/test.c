 ...
 /*case 0x06:{
 	...
 	if(finished==1){
 		sStep scenarioW[] = {
 		   ...
 		   {0x00000020,{2,0x00000000},0x00000000,0},//01
 		   {0x00000020,{2,0x00000000},0x00000000,0},//02
 		   ...
 		   {0x00004000,{2,0x00000000},0x00000000,0},//04
 		   {0x00002000,{0,0x00000800},0x00000000,0},//05
 		   {0x00004000,{2,0x00000000},0x00000000,0},//06

 		   {0x00008000,{0,0x00001000},0x00000000,0},//00
 		   {0x00020000,{1,0x00001000},0x00020000,0},//01
 		   {0x00030000,{0,0x00002000},0x00000000,0},//02

 		   {0x00000200,{1,0x00000000},0x00000000,0},//00
 		   {0x00040000,{1,0x00000000},0x00000000,0}//01

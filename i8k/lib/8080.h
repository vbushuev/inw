...
/*******************************************************************/
/*
Ver 2.0.5 [2006,Aug,8] by Martin
    ==== English comment ==================================
    Modify comments:
        1. i8080_SetChannelMode 
...
extern unsigned char i8080_ChannelMode[8][8];	// slot*8, channel*8
    // 0: Dir/Pulse Counter
    // 1: Up/Down Counter
    // 2: Frequency
    // 3: Up Counter                         
...
int i8080_SetChannelMode(int Slot, int Channel, int Mode);
    ...
    return: 0 ==> No error
            1 ==> The Pulse/Dir counter has one count offset (+1)
                  (due to the input channel is high)  
    Note: When Set Channel Mode, All Channels's values will be Cleared.
    */
